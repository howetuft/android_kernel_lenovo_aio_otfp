...
EXPORT_SYMBOL(AudDrv_ADC3_Clk_Off);
EXPORT_SYMBOL(AudDrv_ADC3_Clk_On);
...
EXPORT_SYMBOL(AudDrv_APLL1Tuner_Clk_Off);
EXPORT_SYMBOL(AudDrv_APLL1Tuner_Clk_On);
EXPORT_SYMBOL(AudDrv_APLL22M_Clk_Off);
EXPORT_SYMBOL(AudDrv_APLL22M_Clk_On);
EXPORT_SYMBOL(AudDrv_APLL24M_Clk_Off);
EXPORT_SYMBOL(AudDrv_APLL24M_Clk_On);
EXPORT_SYMBOL(AudDrv_APLL2Tuner_Clk_Off);
EXPORT_SYMBOL(AudDrv_APLL2Tuner_Clk_On);
EXPORT_SYMBOL(AudDrv_Clk_AllOn);
EXPORT_SYMBOL(AudDrv_Clk_Off);
EXPORT_SYMBOL(AudDrv_Clk_On);
EXPORT_SYMBOL(AudDrv_Clk_Power_Off);
EXPORT_SYMBOL(AudDrv_Clk_Power_On);
EXPORT_SYMBOL(AudDrv_Core_Clk_Off);
EXPORT_SYMBOL(AudDrv_Core_Clk_On);
EXPORT_SYMBOL(AudDrv_Emi_Clk_Off);
EXPORT_SYMBOL(AudDrv_Emi_Clk_On);
EXPORT_SYMBOL(AudDrv_HDMI_Clk_Off);
EXPORT_SYMBOL(AudDrv_HDMI_Clk_On);
EXPORT_SYMBOL(AudDrv_I2S_Clk_Off);
EXPORT_SYMBOL(AudDrv_I2S_Clk_On);
EXPORT_SYMBOL(AudDrv_Suspend_Clk_Off);
EXPORT_SYMBOL(AudDrv_Suspend_Clk_On);
